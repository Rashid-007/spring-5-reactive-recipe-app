package throne.springreacto.recipe.bootstrap;
...
import throne.springreacto.recipe.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        UnitOfMeasure teapoonUom = unitOfMeasureRepository.findByDescription("Teaspoon").orElseThrow(() -> new RuntimeException("Expected UOM not found"));
        ...
        UnitOfMeasure cupsUom = unitOfMeasureRepository.findByDescription("Cup").orElseThrow(() -> new RuntimeException("Expected UOM not found"));
